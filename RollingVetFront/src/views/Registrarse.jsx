    ...
    <main className='flex'>
      ...
      <div className=' w-screen lg:w-8/12 flex flex-col items-center justify-center '>
        ...
        <article className='  w-screen  lg:w-full p-4 md:p-12 lg:p-0'>
            <form onSubmit={handleSubmit()} action="#" method="POST" className='grid grid-rows-7 grid-cols-1 gap-y-8 lg:w-full lg:grid lg:grid-cols-2 lg:grid-rows-4 lg:gap-4 px-4
            2xl:px-32'>
